...
SENSOR_TYPES = {
    ...
    "speed": {"name": "Speed", "unit": "mph", "unit_metric": "km/h", "device_class": "speed", "icon": "mdi:speedometer"},
    "cadence": {"name": "Cadence", "unit": "rpm", "icon": "mdi:rotate-right"},
    "power": {"name": "Power", "unit": "W", "device_class": "power", "icon": "mdi:flash"},
    "altitude": {"name": "Altitude", "unit": "ft", "unit_metric": "cm", "device_class": "distance", "icon": "mdi:altimeter"},
    "distance": {"name": "Distance", "unit": "mi", "unit_metric": "m", "device_class": "distance", "icon": "mdi:arrow-expand-horizontal"},
    ...
    "totaldistance": {"name": "Total Distance", "unit": "m", "device_class": "distance", "icon": "mdi:map-marker-distance"},
    "totaldistanceclimbed": {"name": "Total Distance Climbed", "unit": "ft", "unit_metric": "m", "device_class": "distance", "icon": "mdi:elevation-rise"},

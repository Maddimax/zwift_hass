...
SENSOR_TYPES = {
    ...
    "speed": {"name": "Speed", "unit": "km/h", "device_class": "speed", "icon": "mdi:speedometer"},
    "cadence": {"name": "Cadence", "unit": "rpm", "icon": "mdi:rotate-right"},
    "power": {"name": "Power", "unit": "W", "device_class": "power", "icon": "mdi:flash"},
    "altitude": {"name": "Altitude", "unit": "cm", "device_class": "distance", "icon": "mdi:altimeter"},
    "distance": {"name": "Distance", "unit": "m", "device_class": "distance", "icon": "mdi:arrow-expand-horizontal"},
    ...
    "totaldistanceclimbed": {"name": "Total Distance Climbed", "unit": "m", "device_class": "distance", "icon": "mdi:elevation-rise"},
